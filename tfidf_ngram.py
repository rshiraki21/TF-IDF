...
pd.DataFrame(vectorizer.get_feature_names_out()).to_csv("ngram_feature_names.csv")
pd.DataFrame(tfidf_array).to_csv("ngram_tfidf_matrix.csv")
pd.DataFrame(sort_partitions(partitions)).to_csv("ngram_results.csv")